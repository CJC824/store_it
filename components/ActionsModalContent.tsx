...
const DetailLow = ({ label, value }: { label: string; value: string }) => (
  <div className="flex">
  ...
  return (
    <>
      ...
      <div className="space-y-4 px-2 pt-2">
        ...
        <DetailLow label="Last Edit:" value={formatDateTime(file.$updatedAt)} />
      </div>
    </>
  );
};
  ...
  return (
    <>
      ...
      <div className="share-wrapper">
        <p className="subtitle2 pl-1 text-light-100">
